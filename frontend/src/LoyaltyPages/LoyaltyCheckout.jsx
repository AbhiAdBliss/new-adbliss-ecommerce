          ...
          <Grid item xs={12} md={isLoggedIn ? 8 : 4}>
            ...
            >
              <Typography
                variant="h5"
                fontWeight={800}
                sx={{ fontSize: { xs: "1.3rem", md: "1.5rem" }, textAlign: { xs: "center", sm: "left" } }}
              >
                {product.name}
              </Typography>
  ...
  <Typography sx={{ color: "red", mt: 1 }}>
    You have already redeemed this coupon
              ...
              {product.features.map((f, i) => (
                <Typography key={i} sx={{ mb: 1,textAlign: { xs: "center", sm: "left" } }}>
                  • {f}
                </Typography>
              ))}
              ...
              {isLoggedIn && (
                <Box>
                  ...
                  <Typography sx={{ color: "#555", mb: 1.5,textAlign: { xs: "center", sm: "left" } }}>
                  ...
                  <Typography sx={{ color: "#555",textAlign: { xs: "center", sm: "left" } }}>
